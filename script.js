...
course =  "CIS102"; 
console.log(course);
// It's working, we can re assign to the variable created using let
// Task 2.2 — const safety
// Create const SCHOOL = "MyCollege"; then TRY to reassign it and observe theConsole  error. Add a comment explaining    why  reassignment fails.
// const SCHOOL = "MyCollege"
// SCHOOL = "Test" 
// 
// NOTE: For now, keep the reassignment line commented so the file runs without errors.
const SCHOOL = "MyCollege";
// SCHOOL = "OtherCollege"; //The above re assigning will not work because of the nature of const, we can not use re ass
...
let x = "2", y = 3
console.log(x + y); // The plus will concatinate, it will convet the y to string
console.log(x - y); // When using - sign it will convert x to integer, same form *, / and %
console.log(x * y)
console.log(x / y);
console.log(x % y);
...
//         - "Aged" if age > 35
// write code here
let ageInp = prompt("Enter your age:");
let age = Number(ageInp);
if (age > 0 & age < 13) {
    console.log("Child");
...
console.log("Sum integers 1..10 =", result);
...
if (typeof b === "undefined") {
    console.log("b is not accessible (block-scoped)")
} else {
    console.log("b =", b)
}
